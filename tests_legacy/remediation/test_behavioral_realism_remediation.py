...
from src_legacy.core.models.life_events import ReputationProfile
from src_legacy.core.models.enums import Faction as FactionEnum, AIState, ActionType, Material
from src_legacy.core.gameplay.buildings import item_sell_price, shop_buy_price
...
from tests_legacy.benchmarks.test_scaling_bench import run_bench
from src_legacy.ai.states.interaction import find_nearby_resource
from src_legacy.ai.states.navigation import propose_retreat_home
...
def test_pricing_reputation_scaling():
    ...
    from src_legacy.core.models.enums import Rarity, ItemType
