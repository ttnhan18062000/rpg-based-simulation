import pytest
from src_legacy.core.state import AuthoritativeState, EntityState, IdentityComponent, NavigationComponent, TaskComponent, CombatComponent
from src_legacy.core.updates import StateUpdate, EntityUpdate, NavigationUpdate, TaskUpdate, CombatUpdate
