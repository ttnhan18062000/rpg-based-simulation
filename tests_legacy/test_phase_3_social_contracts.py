...
from src_legacy.core.models.enums import OfferStatus, ContractKind, StrategicStatus, GoalType
from src_legacy.core.models.strategy import ProjectRecord, ContractTermRecord, RecruitmentOfferRecord, SocialContractRecord
...
from src_legacy.core.models.lived_structure import GroupRecord
...
def custom_mock_ctx():
    ...
    actor.mind = SimpleNamespace(
        ...
        narrative=SimpleNamespace(memory_log=[], turning_points=[])
    )
...
def test_role_aware_tactical_biases(custom_mock_ctx):
    ...
    from src_legacy.core.models.strategy import ProjectRecord, ObjectiveKind, ProjectRecord
