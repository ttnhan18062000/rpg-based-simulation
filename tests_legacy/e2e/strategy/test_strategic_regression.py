...
from src_legacy.testing.assertions import load_json, assert_graph_integrity, assert_strategic_consistency
...
class TestStrategicRegression:
    ...
    def test_cross_artifact_consistency(self, runner):
        ...
        from src_legacy.testing.assertions import assert_strategic_consistency, assert_cognition_consistency
