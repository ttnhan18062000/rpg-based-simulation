...
from src_legacy.core.models.enums import AIState, EnemyTier, EntityRole, Faction, HeroClass, Rarity, Domain, ActionType
...
def test_calamity_bounty_generation(basic_setup):
    ...
    from src_legacy.core.gameplay.quests import QuestType
