...
from src_legacy.api.schemas import StrategicStateSchema, CognitionCapacitySchema, CognitionBudgetUsageSchema, CognitionOverloadSchema
...
def test_populated_artifact_consistency():
    ...
    from src_legacy.testing.assertions import load_json, assert_strategic_consistency
