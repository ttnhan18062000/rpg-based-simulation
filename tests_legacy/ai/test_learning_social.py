...
from src_legacy.core.models.strategy import LeadRecord, LeadKind, ProjectRecord, ObjectiveRecord, ObjectiveKind, StrategicStatus
...
from src_legacy.core.models.enums import AIState, InterpretedLifeEventKind

def test_intel_confirmation_by_sight():
    """Verify that seeing a person mentioned in a lead confirms it and boosts trust."""
    from src_legacy.core.models.strategy import ProjectKind
