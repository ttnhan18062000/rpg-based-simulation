...
from src_legacy.core.models.strategy import RecruitmentOfferRecord, ProjectRecord
from src_legacy.core.models.life_events import TurningPointRecord
from src_legacy.core.models.enums import TurningPointKind, OfferStatus, ContractKind
...
def test_betrayal_social_consequence(base_ctx):
    ...
    from src_legacy.core.models.enums import ProjectKind
