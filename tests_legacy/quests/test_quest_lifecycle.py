...
from src_legacy.core.quests import QuestState, QuestStatus, RewardState, QuestKind
from src_legacy.core.strategic import StrategicComponent
from src_legacy.core.updates import EntityUpdate, QuestUpdate, StateUpdate
