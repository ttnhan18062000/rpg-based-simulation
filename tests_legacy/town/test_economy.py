import pytest
from src_legacy.core.state import AuthoritativeState, EntityState, BuildingState, InventoryComponent, ItemStack
from src_legacy.town.shop import ShopService
from src_legacy.town.blacksmith import BlacksmithService
