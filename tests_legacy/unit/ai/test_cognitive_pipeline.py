...
from src_legacy.core.models.enums import AIState, ActionType, GoalType
from src_legacy.actions.base import ActionProposal, MindUpdate
...
def test_perception_phase_appraisal_sync(mock_brain):
    from src_legacy.core.models.enums import EmotionType
