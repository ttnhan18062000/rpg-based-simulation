...
from src_legacy.core.models.enums import GoalType, AIState, ActionType, EntityRole
...
from src_legacy.actions.base import RoutineUpdate, MindUpdate
...
def test_inn_visit_leads_to_sleeping(routine_entity):
    from src_legacy.ai.states.town import VisitInnHandler
...
def test_home_visit_leads_to_eating(routine_entity):
    from src_legacy.ai.states.town import VisitHomeHandler
    from src_legacy.actions.base import RoutineUpdate
