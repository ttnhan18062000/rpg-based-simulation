import pytest
from src_legacy.ai.brain import AIContext
from src_legacy.core.entities.entity import Entity
from src_legacy.core.models.snapshot import Snapshot
from src_legacy.core.models.enums import AIState, StrategicStatus, OfferStatus, ContractKind, ProjectKind
from src_legacy.platform.rng import DeterministicRNG
from src_legacy.config import SimulationConfig
from src_legacy.core.models.strategy import ProjectRecord, RecruitmentOfferRecord, ContractTermRecord
from src_legacy.core.models.life_events import SocialBondRecord
...
def test_recruiter_evaluates_counter():
    ...
    from src_legacy.ai.strategy.recruitment_negotiation import OfferAppraisal
