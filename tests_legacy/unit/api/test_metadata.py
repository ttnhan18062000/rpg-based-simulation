...
class TestMetadataEndpoints:
    ...
    def test_get_enums(self):
        ...
        from src_legacy.api.routes.metadata import get_enums
        e = get_enums()
    ...
    def test_get_items(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_items
        result = get_items()
        items = result["items"]
    ...
    def test_get_classes(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_classes
        c = get_classes()
    ...
    def test_get_traits(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_traits
        result = get_traits()
    ...
    def test_get_attributes(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_attributes
        a = get_attributes()
    ...
    def test_get_buildings(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_buildings
        b = get_buildings()
    ...
    def test_get_resources(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_resources
        r = get_resources()
        assert len(r.resource_types) > 0

    def test_get_recipes(self):
        pytest.importorskip("fastapi")
        from src_legacy.api.routes.metadata import get_recipes
        r = get_recipes()
