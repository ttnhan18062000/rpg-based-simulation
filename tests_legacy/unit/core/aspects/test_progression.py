...
from src_legacy.core.gameplay.attributes import Attributes, AttributeCaps, train_attributes
from src_legacy.core.models.enums import AIState, Domain, VeterancyRank, ActionType
