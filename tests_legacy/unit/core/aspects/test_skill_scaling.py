...
from src_legacy.core.models.enums import DamageType, Element, SkillType, SkillTarget, ActionType, Faction
from src_legacy.core.gameplay.classes import SkillDef, SkillInstance, SKILL_DEFS
