...
from src_legacy.core.models.enums import AIState, ActionType, Domain, EnemyTier, RACE_PROFILES
...
from src_legacy.core.gameplay.items.items import ItemTemplate, ItemType
