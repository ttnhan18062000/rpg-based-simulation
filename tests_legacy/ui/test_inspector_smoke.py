...
from src_legacy.core.models.enums import AIState, StrategicStatus, ObjectiveKind, ProjectKind, DirectiveKind, TurningPointKind, ContractKind, ConcernKind, LeadKind, OfferStatus
from src_legacy.core.models.strategy import StrategicState, ProjectRecord, ObjectiveRecord, DirectiveRecord, ConcernRecord, CandidateZoneRecord, HypothesisRecord, SocialContractRecord, RecruitmentOfferRecord
