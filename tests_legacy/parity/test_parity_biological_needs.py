import pytest
from src_legacy.core.state import AuthoritativeState, EntityState, BiologicalComponent, CombatComponent, StrategicComponent, BuildingState
from src_legacy.core.updates import StateUpdate, EntityUpdate, TaskUpdate
...
def test_biological_recovery_at_building():
    ...
    from src_legacy.core.updates import TaskUpdate
