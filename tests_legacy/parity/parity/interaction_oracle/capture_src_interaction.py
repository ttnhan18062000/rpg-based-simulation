...
from src_legacy.ai.states.interaction import LootingHandler, HarvestingHandler
from src_legacy.ai.states.base import AIContext
from src_legacy.core.models.enums import ActionType, AIState, GoalType, Faction, MovementIntention
...
def run_oracle():
    ...
    output_path = "tests/parity/interaction_oracle/results.json"
