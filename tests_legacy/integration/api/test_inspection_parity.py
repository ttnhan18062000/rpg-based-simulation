...
from src_legacy.core.models.enums import Faction, LifeRole, AIState, GoalType
from src_legacy.core.models.lived_structure import PlaceAttachment, AttachmentKind
