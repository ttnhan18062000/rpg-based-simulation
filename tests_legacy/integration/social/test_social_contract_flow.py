...
from src_legacy.core.models.enums import GoalType, Faction, OfferStatus, ContractKind, GroupKind
from src_legacy.core.models.strategy import StrategicStatus, RecruitmentOfferRecord, SocialContractRecord
