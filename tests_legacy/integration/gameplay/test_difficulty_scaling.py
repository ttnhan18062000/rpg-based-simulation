...
from src_legacy.core.models.enums import EnemyTier, Material
...
class TestSpawnDifficultyScaling(unittest.TestCase):
    ...
    def test_difficulty_sets_level_range(self):
        ...
        self.assertGreaterEqual(e.progression.level, diff.level_min)
        self.assertLessEqual(e.progression.level, diff.level_max)
    ...
    def test_gold_scales_with_difficulty(self):
        ...
        self.assertGreaterEqual(e4.progression.gold, e1.progression.gold)
