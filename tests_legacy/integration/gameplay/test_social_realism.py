...
from src_legacy.core.models.enums import InterpretedLifeEventKind, TurningPointKind, EntityRole
...
from src_legacy.core.models.social import SocialRegistry, SocialBond
