...
from src_legacy.core.models.enums import ActionType, InterpretedLifeEventKind, TurningPointKind, EntityRole
...
from src_legacy.actions.base import ActionProposal, CombatTraceUpdate
...
def test_social_event_betrayal(world, hero, ally):
    ...
    from src_legacy.actions.base import PerceptionUpdate, ReputationUpdate, SocialUpdate
