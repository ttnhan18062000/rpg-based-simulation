...
from src_legacy.actions.base import ActionProposal, NavigationUpdate, ProgressionUpdate
from src_legacy.ai.states import (
...
from src_legacy.core.gameplay.items.items import Inventory
...
def _make_mob(
    ...
    from src_legacy.core.aspects.mind import DecisionState, PerceptionMemory, EmotionState, NavigationState, NarrativeMemory
