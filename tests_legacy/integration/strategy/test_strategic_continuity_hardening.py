...
from src_legacy.core.models.enums import AIState, StrategicStatus, ObjectiveKind, ProjectKind
from src_legacy.core.models.strategy import ProjectRecord, ObjectiveRecord
