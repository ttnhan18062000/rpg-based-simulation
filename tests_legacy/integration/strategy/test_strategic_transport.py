...
from src_legacy.core.models.enums import ActionType, StrategicStatus, DirectiveKind, ProjectKind
from src_legacy.actions.base import ActionProposal, StrategicUpdate
from src_legacy.core.models.strategy import DirectiveRecord, ProjectRecord, ConcernRecord
...
def test_strategic_update_multi_record_transport(base_world):
    ...
    from src_legacy.core.models.enums import ConcernKind
