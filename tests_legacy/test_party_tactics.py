...
from src_legacy.core.models.enums import GoalType, ObjectiveKind, GroupKind
from src_legacy.core.models.strategy import ObjectiveRecord, ProjectRecord, ProjectKind
