import pytest
from src_legacy.core.state import AuthoritativeState, EntityState, IdentityComponent, CombatComponent, AttributeComponent, AptitudeComponent
from src_legacy.core.updates import StateUpdate, EntityUpdate, RewardUpdate
from src_legacy.engine.apply import ApplyPath
from src_legacy.actions.attributes import AllocateAttributeAction
