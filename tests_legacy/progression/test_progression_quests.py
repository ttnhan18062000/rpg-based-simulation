...
"""
import pytest
from src_legacy.core.state import EntityState, RegionState
from src_legacy.core.strategic import StrategicComponent, BlockerState, ProjectStatus
from src_legacy.systems.quests import QuestGenerationSystem
