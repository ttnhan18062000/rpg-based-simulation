...
from src_legacy.core.state import EntityState, LifecycleComponent, AuthoritativeState, CombatComponent
from src_legacy.core.updates import StateUpdate, EntityUpdate, CombatUpdate, InventoryUpdate
