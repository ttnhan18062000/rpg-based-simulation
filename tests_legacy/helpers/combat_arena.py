...
from src_legacy.core.gameplay.classes import HeroClass, SkillInstance, SKILL_DEFS
from src_legacy.core.gameplay.effects import StatusEffect
from src_legacy.core.models.enums import AIState, EnemyTier, Material, EntityRole
...
class CombatArena:
    ...
    def add_entity(
        ...
        *,
        ...
        from src_legacy.core.models.strategy import StrategicState, ProjectRecord, ObjectiveRecord, ProjectKind, StrategicStatus
        from src_legacy.core.models.enums import ObjectiveKind as ObjKind
