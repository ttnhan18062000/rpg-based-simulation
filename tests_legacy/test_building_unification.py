...
from src_legacy.ai.states.town import (
...
from src_legacy.actions.base import ActionProposal, PerceptionUpdate, StrategicUpdate
...
from src_legacy.core.gameplay.items.item_registry import ItemTemplate, ItemType, ITEM_REGISTRY
...
def test_visit_guild_no_legacy_goals(mock_world, ai_context, test_actor):
    ...
    import src_legacy.core.gameplay.quests as quests
    quests.MAX_ACTIVE_QUESTS = 0

    from src_legacy.core.gameplay.buildings import Recipe
    import src_legacy.core.gameplay.buildings as buildings
...
def test_visit_class_hall_resolution(mock_world, ai_context, test_actor):
    ...
    from src_legacy.core.gameplay.classes import CLASS_DEFS, HeroClass
    # Mock skill definition and mastery
    from src_legacy.core.gameplay.classes import SkillDef, Element, ClassDef
    import src_legacy.core.gameplay.classes as classes
