...
import pytest
from src_legacy.core.state import EntityState, SocialComponent, IdentityComponent, SocialBond
from src_legacy.core.updates import SocialUpdate, SocialBondUpdate
