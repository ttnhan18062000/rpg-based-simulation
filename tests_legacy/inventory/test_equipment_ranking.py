import pytest
from src_legacy.core.state import EntityState, IdentityComponent, EquipmentComponent, EquipSlot, ItemKind
from src_legacy.core.items import ItemDefinition
from src_legacy.core.equipment_service import EquipmentService
