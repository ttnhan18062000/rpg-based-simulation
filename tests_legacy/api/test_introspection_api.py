...
import pytest
from src_legacy.api.schemas import EntityInspectionSchema, SchedulerTimelineItemSchema
...
def test_scheduler_timeline(world, rng):
    from src_legacy.api.presenters.scheduler_presenter import SchedulerPresenter
...
def test_behavioral_realism_api_integration(world, rng):
    ...
    from src_legacy.core.aspects.mind import PersonalityProfile, PersonalMotive, BeliefRecord, ThreatEstimate
    from src_legacy.core.models.vectors import Vector2
