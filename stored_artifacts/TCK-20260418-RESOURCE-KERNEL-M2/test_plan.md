...
### 1. Minimal Kernel Execution (`tests_v2/engine/test_minimal_kernel.py`)
...
### 2. Authoritative Apply Path (`tests_v2/engine/test_authoritative_apply.py`)
...
### 3. Readiness Gating (`tests_v2/engine/test_readiness.py`)
...
### 4. Determinism Suite (`tests_v2/engine/test_determinism_suite.py`)
