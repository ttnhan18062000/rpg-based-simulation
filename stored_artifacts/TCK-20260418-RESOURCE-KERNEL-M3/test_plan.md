...
### 1. Bounded Collections (`tests_v2/core/test_bounded_collections.py`)
...
### 2. Model Separation (`tests_v2/engine/test_runtime_state_contract.py`)
...
### 3. Registry Retention (`tests_v2/engine/test_retention_logic.py`)
...
### 4. Determinism vs Overflows (`tests_v2/engine/test_overflow_determinism.py`)
