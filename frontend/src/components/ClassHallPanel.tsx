...
interface BreakthroughInfo {
  ...
  talent: string;
  talent_desc: string;
  bonuses: { str: number; agi: number; vit: number; int: number; wis: number; end: number };
  cap_bonuses: { str: number; agi: number; vit: number; int: number; wis: number; end: number };
}
...
interface ClassData {
  ...
  lore: string;
  playstyle: string;
  attr_bonuses: { str: number; agi: number; vit: number; int: number; wis: number; end: number };
  cap_bonuses: { str: number; agi: number; vit: number; int: number; wis: number; end: number };
  scaling: { str: ScalingGrade; agi: ScalingGrade; vit: ScalingGrade; int: ScalingGrade; wis: ScalingGrade; end: ScalingGrade };
  skills: ClassSkill[];
...
const CLASSES: Record<string, ClassData> = {
  warrior: {
    ...
    attr_bonuses: { str: 3, agi: 0, vit: 2, int: 0, wis: 0, end: 1 },
    cap_bonuses: { str: 10, agi: 0, vit: 5, int: 0, wis: 0, end: 3 },
    scaling: { str: 'S', agi: 'D', vit: 'A', int: 'E', wis: 'D', end: 'B' },
    ...
    breakthrough: {
      ...
      bonuses: { str: 3, agi: 0, vit: 2, int: 0, wis: 0, end: 0 },
      cap_bonuses: { str: 10, agi: 0, vit: 5, int: 0, wis: 0, end: 0 },
    },
    breakthrough_class: {
      ...
      attr_bonuses: { str: 6, agi: 0, vit: 4, int: 0, wis: 0, end: 2 },
      cap_bonuses: { str: 20, agi: 0, vit: 10, int: 0, wis: 0, end: 6 },
  ...
  ranger: {
    ...
    attr_bonuses: { str: 0, agi: 3, vit: 0, int: 0, wis: 2, end: 1 },
    cap_bonuses: { str: 0, agi: 10, vit: 0, int: 0, wis: 5, end: 3 },
    scaling: { str: 'D', agi: 'S', vit: 'D', int: 'D', wis: 'B', end: 'A' },
    ...
    breakthrough: {
      ...
      bonuses: { str: 0, agi: 3, vit: 0, int: 0, wis: 2, end: 0 },
      cap_bonuses: { str: 0, agi: 10, vit: 0, int: 0, wis: 5, end: 0 },
    },
    breakthrough_class: {
      ...
      attr_bonuses: { str: 0, agi: 6, vit: 0, int: 0, wis: 4, end: 2 },
      cap_bonuses: { str: 0, agi: 20, vit: 0, int: 0, wis: 10, end: 6 },
  ...
  mage: {
    ...
    attr_bonuses: { str: 0, agi: 0, vit: 1, int: 3, wis: 2, end: 0 },
    cap_bonuses: { str: 0, agi: 0, vit: 3, int: 10, wis: 5, end: 0 },
    scaling: { str: 'E', agi: 'D', vit: 'C', int: 'S', wis: 'A', end: 'C' },
    skills: MAGE_SKILLS,
    breakthrough: {
      from_class: 'Mage', to_class: 'Archmage', level_req: 10,
      attr_req: 'INT', attr_threshold: 30, talent: 'Arcane Mastery',
      talent_desc: TALENT_DESCRIPTIONS['Arcane Mastery'],
      bonuses: { str: 0, agi: 0, vit: 0, int: 3, wis: 2, end: 0 },
      cap_bonuses: { str: 0, agi: 0, vit: 0, int: 10, wis: 5, end: 0 },
    },
    breakthrough_class: {
      ...
      playstyle: 'Archmages reach SS-rank INT scaling, making their skills devastatingly powerful. S-rank WIS dramatically boosts XP gain and luck. The ultimate glass cannon \u2014 when positioned correctly, an Archmage can end battles before they begin.',
      attr_bonuses: { str: 0, agi: 0, vit: 2, int: 6, wis: 4, end: 0 },
      cap_bonuses: { str: 0, agi: 0, vit: 6, int: 20, wis: 10, end: 0 },
  ...
  rogue: {
    ...
    attr_bonuses: { str: 2, agi: 2, vit: 0, int: 0, wis: 1, end: 0 },
    cap_bonuses: { str: 5, agi: 8, vit: 0, int: 0, wis: 3, end: 0 },
    scaling: { str: 'B', agi: 'S', vit: 'D', int: 'D', wis: 'C', end: 'C' },
    skills: ROGUE_SKILLS,
    breakthrough: {
      ...
      bonuses: { str: 2, agi: 3, vit: 0, int: 0, wis: 0, end: 0 },
      cap_bonuses: { str: 5, agi: 8, vit: 0, int: 0, wis: 0, end: 0 },
    },
    breakthrough_class: {
      ...
      attr_bonuses: { str: 4, agi: 5, vit: 0, int: 0, wis: 2, end: 0 },
      cap_bonuses: { str: 10, agi: 16, vit: 0, int: 0, wis: 6, end: 0 },
...
const ATTR_LABELS = ['STR', 'AGI', 'VIT', 'INT', 'WIS', 'END'] as const;
const ATTR_KEYS = ['str', 'agi', 'vit', 'int', 'wis', 'end'] as const;
const ATTR_COLORS: Record<string, string> = {
  str: '#f87171', agi: '#34d399', vit: '#fb923c', int: '#818cf8', wis: '#a78bfa', end: '#fbbf24',
};
const ATTR_EFFECTS: Record<string, string> = {
  str: 'ATK +0.5/pt', agi: 'SPD +0.4, Crit +0.4%, Eva +0.3%',
  vit: 'HP +2, DEF +0.3/pt', int: 'XP gain +1%/pt',
  wis: 'Luck +0.3, XP +0.5%/pt', end: 'Stamina +2, HP +0.5/pt',
};
