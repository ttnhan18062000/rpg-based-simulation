...
- `tools/agent-monitoring/generate_retro.py`, `tools/agent-monitoring/query.py`, and the
  existing dashboard surfaces (`experiments/agent_ops_dashboard/`, `dashboard-frontend/`)
  — the "dashboard/retro queries" this phase's AC must extend, not replace or fork.
