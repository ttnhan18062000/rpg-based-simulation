...
1. [Live Map Rendering and Surface Integration](./render-and-art/README.md);
2. [Aseprite Agent-Controlled Pixel Art](./aseprite-mcp-pixel-art/README.md);
3. [Visual Asset Management and Runtime Integration](./visual-asset-management-runtime-integration/README.md).
...
| Existing HUD M1–M4 content delivery | [HUD delivery roadmap](./hud_delivery_roadmap.md) and tickets | HUD sequence remains M1 → M2 → M3 → M4 |
| Measured Canvas optimization and interest management | [Live Map scaling roadmap](./live_map_scaling_roadmap.md) and open epics | Start only on measured need; neither is implied by renderer experiments |
| Agent-controlled drawing and `CAP-A`/`CAP-B` | Aseprite package | CAP-A remains deliverable without CAP-B |
| Manual drawing questions and identities | [Manual art experiment plan](./render-and-art/07_manual_art_experiment_execution_plan.md) | Results may inform candidates, never production specifications directly |
...
- [Live Map/HUD milestone roadmap](./live_map_rendering_and_surface_integration_milestone_plan.md)
- [Live Map/HUD detailed package](./render-and-art/README.md)
- [Live Map scaling roadmap](./live_map_scaling_roadmap.md)
- [HUD delivery roadmap](./hud_delivery_roadmap.md)
- [Aseprite milestone package](./aseprite-mcp-pixel-art/README.md)
- [Visual asset management milestone package](./visual-asset-management-runtime-integration/README.md)
