...
|---|---|---|---|---|---|---|
| `action_pacing_readiness` | entity | done | runtime | observed | 130 | 26 |
...
| `betrayal_siege_war` | faction | done | unverified | unverified | 42 | 14 |
...
| `regional_sovereignty` | region | done | static | observed | 14 | 7 |
| `reputation` | faction | done | unverified | unverified | 12 | 4 |
| `attributes_biology` | entity | done | unverified | unverified | 10 | 2 |
| `regional_trauma` | region | done | runtime | contradicted | 10 | 5 |
| `world_generation` | world | done | unverified | unverified | 8 | 8 |
| `city` | region | partial | unverified | unverified | 6 | 3 |
...
| `tactical_decision` | entity | done | runtime | contradicted | 5 | 1 |
