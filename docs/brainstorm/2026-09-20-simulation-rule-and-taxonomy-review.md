...
> **Outcome, 2026-09-20: all 13 adopted**, in two passes — the vocabulary changes first, then the domain-map and measurement changes once the owner decided to build the clean taxonomy ahead of implementation. They are folded into [`core_rpg_design_direction.md`](core_rpg_design_direction.md) §7/§9/§10/§11, and listed in its §15. The list below is kept as the original reasoning.
