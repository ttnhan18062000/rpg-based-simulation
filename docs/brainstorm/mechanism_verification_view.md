...
11 of 89 mechanisms have a recorded verdict. The remaining 78 are rendered explicitly as `unverified` below, not omitted — a mechanism with no verdict is not the same as a mechanism known to work.
