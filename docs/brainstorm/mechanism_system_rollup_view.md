...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `cognition` | 20 | 18/20 (90.0%, +7.2pt vs baseline) | 20/20 (100.0%, +10.8pt vs baseline) [11 runtime, 9 static] | 11/20 (55.0%, +26.1pt vs baseline) | 0 | 9 | 0 | 1 | 5 | 5 | 0 |
| `combat` | 8 | 8/8 (100.0%, +17.2pt vs baseline) | 8/8 (100.0%, +10.8pt vs baseline) [4 runtime, 4 static] | 4/8 (50.0%, +21.1pt vs baseline) | 0 | 6 | 1 | 0 | 1 | 0 | 0 |
| `economy` | 8 | 7/8 (87.5%, +4.7pt vs baseline) | 7/8 (87.5%, -1.7pt vs baseline) [0 runtime, 7 static] | 0/7 (0.0%, -28.9pt vs baseline) | 0 | 4 | 1 | 1 | 2 | 0 | 0 |
| `faction` | 13 | 9/13 (69.2%, -13.6pt vs baseline) | 9/13 (69.2%, -20.0pt vs baseline) [0 runtime, 9 static] | 0/9 (0.0%, -28.9pt vs baseline) | 0 | 6 | 3 | 3 | 0 | 0 | 1 |
| `progression` | 15 | 14/15 (93.3%, +10.5pt vs baseline) | 15/15 (100.0%, +10.8pt vs baseline) [7 runtime, 8 static] | 7/15 (46.7%, +17.8pt vs baseline) | 0 | 8 | 5 | 0 | 0 | 2 | 0 |
| `social` | 12 | 8/12 (66.7%, -16.1pt vs baseline) | 9/12 (75.0%, -14.2pt vs baseline) [0 runtime, 9 static] | 0/9 (0.0%, -28.9pt vs baseline) | 0 | 5 | 2 | 3 | 2 | 0 | 0 |
| `world` | 25 | 20/25 (80.0%, -2.8pt vs baseline) | 22/25 (88.0%, -1.2pt vs baseline) [3 runtime, 19 static] | 3/22 (13.6%, -15.3pt vs baseline) | 0 | 14 | 2 | 4 | 4 | 1 | 0 |
