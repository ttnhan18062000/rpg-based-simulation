...
**Baseline (all 93 mechanisms)**: 76 bound (81.7%), 82 verified (88.2% — 9 runtime, 73 static), 11 unverified (0 of those bound-but-unverified). State breakdown: done 48, partial 12, gap 12, orphan 12, gated 7, skeleton 2.

| System | Mechanisms | Bound (vs baseline) | Verified (vs baseline) | Bound, Unverified | done | partial | gap | orphan | gated | skeleton |
|---|---|---|---|---|---|---|---|---|---|---|
| `cognition` | 20 | 18/20 (90.0%, +8.3pt vs baseline) | 20/20 (100.0%, +11.8pt vs baseline) [0 runtime, 20 static] | 0 | 10 | 0 | 1 | 4 | 4 | 1 |
| `combat` | 8 | 8/8 (100.0%, +18.3pt vs baseline) | 8/8 (100.0%, +11.8pt vs baseline) [4 runtime, 4 static] | 0 | 6 | 1 | 0 | 1 | 0 | 0 |
| `economy` | 8 | 7/8 (87.5%, +5.8pt vs baseline) | 7/8 (87.5%, -0.7pt vs baseline) [0 runtime, 7 static] | 0 | 4 | 1 | 1 | 2 | 0 | 0 |
| `faction` | 13 | 9/13 (69.2%, -12.5pt vs baseline) | 9/13 (69.2%, -18.9pt vs baseline) [0 runtime, 9 static] | 0 | 6 | 3 | 3 | 0 | 0 | 1 |
| `progression` | 15 | 13/15 (86.7%, +4.9pt vs baseline) | 14/15 (93.3%, +5.2pt vs baseline) [3 runtime, 11 static] | 0 | 8 | 4 | 1 | 0 | 2 | 0 |
| `social` | 12 | 8/12 (66.7%, -15.1pt vs baseline) | 9/12 (75.0%, -13.2pt vs baseline) [0 runtime, 9 static] | 0 | 5 | 2 | 3 | 2 | 0 | 0 |
| `world` | 25 | 20/25 (80.0%, -1.7pt vs baseline) | 22/25 (88.0%, -0.2pt vs baseline) [2 runtime, 20 static] | 0 | 14 | 2 | 4 | 4 | 1 | 0 |
