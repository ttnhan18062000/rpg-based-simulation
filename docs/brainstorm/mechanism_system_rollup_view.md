...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `cognition` | 20 | 18/20 (90.0%, +8.3pt vs baseline) | 20/20 (100.0%, +11.8pt vs baseline) [11 runtime, 9 static] | 11/20 (55.0%, +30.6pt vs baseline) | 0 | 9 | 0 | 1 | 5 | 5 | 0 |
| `combat` | 8 | 8/8 (100.0%, +18.3pt vs baseline) | 8/8 (100.0%, +11.8pt vs baseline) [4 runtime, 4 static] | 4/8 (50.0%, +25.6pt vs baseline) | 0 | 6 | 1 | 0 | 1 | 0 | 0 |
| `economy` | 8 | 7/8 (87.5%, +5.8pt vs baseline) | 7/8 (87.5%, -0.7pt vs baseline) [0 runtime, 7 static] | 0/7 (0.0%, -24.4pt vs baseline) | 0 | 4 | 1 | 1 | 2 | 0 | 0 |
| `faction` | 13 | 9/13 (69.2%, -12.5pt vs baseline) | 9/13 (69.2%, -18.9pt vs baseline) [0 runtime, 9 static] | 0/9 (0.0%, -24.4pt vs baseline) | 0 | 6 | 3 | 3 | 0 | 0 | 1 |
| `progression` | 15 | 13/15 (86.7%, +4.9pt vs baseline) | 14/15 (93.3%, +5.2pt vs baseline) [3 runtime, 11 static] | 3/14 (21.4%, -3.0pt vs baseline) | 0 | 8 | 4 | 1 | 0 | 2 | 0 |
| `social` | 12 | 8/12 (66.7%, -15.1pt vs baseline) | 9/12 (75.0%, -13.2pt vs baseline) [0 runtime, 9 static] | 0/9 (0.0%, -24.4pt vs baseline) | 0 | 5 | 2 | 3 | 2 | 0 | 0 |
| `world` | 25 | 20/25 (80.0%, -1.7pt vs baseline) | 22/25 (88.0%, -0.2pt vs baseline) [3 runtime, 19 static] | 3/22 (13.6%, -10.8pt vs baseline) | 0 | 14 | 2 | 4 | 4 | 1 | 0 |
