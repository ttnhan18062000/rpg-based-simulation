...
- **[Logic Checklist](checklist.md)**: The master exhaustive ledger of every gameplay law verified against the engine.
...
The RPG Engine uses a multi-tier certification process:
