...
Agents that search for prior work or relevant docs should query **`docs/REGISTRY.yaml`** before scanning raw directories. The registry is a flat index of all tagged docs and closed tickets generated by `tools/generate_registry.py`.
