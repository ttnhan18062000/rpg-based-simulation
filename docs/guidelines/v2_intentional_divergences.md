...
- **Verification**: `docs/engine/progression_surface_matrix.md`
...
- **Verification**: `docs/engine/resource_exit_support_boundary.md`
...
- **Verification**: `docs/engine/resource_intelligence_support.md`
