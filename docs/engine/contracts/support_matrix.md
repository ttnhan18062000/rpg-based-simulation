...
See [Phase 5 Truth Package](../engine/resource_truth_package.md) for detailed divergences and [Phase 5 Proof Bundle](../engine/resource_proof_bundle.md) for evidence.

| Subsystem | Feature | Status | Parity | Verification Artifact |
| :--- | :--- | :--- | :--- | :--- |
| **Grid** | Tile Movement | **OFFICIAL** | Bit-Identical | [Proof Bundle](../engine/resource_proof_bundle.md) |
| **Grid** | Cardinal Step | **OFFICIAL** | Bit-Identical | [Proof Bundle](../engine/resource_proof_bundle.md) |
| **Grid** | Collision | **EXPERIMENTAL**| Divergent | [Divergence Log](../engine/divergence_log.md) |
| **Interaction**| Looting | **OFFICIAL** | Bit-Identical | [Proof Bundle](../engine/resource_proof_bundle.md) |
| **Interaction**| Harvesting | **OFFICIAL** | Bit-Identical | [Proof Bundle](../engine/resource_proof_bundle.md) |
| **Town** | Blacksmithing | **SUPPORTED**| Simplified | [Divergence Log](../engine/divergence_log.md) |
| **Town** | Redirection | **OFFICIAL** | Bit-Identical | [Proof Bundle](../engine/resource_proof_bundle.md) |
| **AI** | Seek Loop | **OFFICIAL** | Bit-Identical | [Proof Bundle](../engine/resource_proof_bundle.md) |
