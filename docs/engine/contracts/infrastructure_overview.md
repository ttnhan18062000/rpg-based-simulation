...
*   **Deep-Dive Reference**: See [docs/observability/simulation_mining.md](file:///home/vboxuser/Work/rpg-based-simulation/docs/observability/simulation_mining.md) for mining schemas, [docs/observability/simulation_mining_usage.md](file:///home/vboxuser/Work/rpg-based-simulation/docs/observability/simulation_mining_usage.md) for execution templates, and [docs/engine/contracts/sweep_configuration.md](file:///home/vboxuser/Work/rpg-based-simulation/docs/engine/contracts/sweep_configuration.md) for sweep schemas and JSON examples.
