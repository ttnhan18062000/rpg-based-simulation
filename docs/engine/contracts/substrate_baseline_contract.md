...
# Substrate Baseline Contract

## 1. Purpose
This document defines the authoritative law for the deterministic single-process engine substrate. It establishes the stable foundation required for RPG gameplay attachment.
...
1. **Class Hierarchy**:
   ...
   - `OPPORTUNISTIC` (Optional Enrichment) - Gated/Disabled in the current baseline.
2. **Tie-Break Rules**:
