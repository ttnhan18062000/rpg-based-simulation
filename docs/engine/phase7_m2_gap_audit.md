...
- **Location**: `src_v2/core/` (Missing), `src_v2/actions/` (Missing)
...
- **Location**: `src_v2/core/updates.py`
...
- **Required**: Port the `ActionReason` enum and logic from legacy to `src_v2/core/enums.py` or similar.

### Gap C: Structural Drift (Kernel-side Routing)
- **Location**: `src_v2/engine/kernel.py:L283-L334`
...
- **Location**: `src_v2/core/updates.py:L55-L70`
...
- [ ] **Task 2**: Create `src_v2/core/actions.py` with `ActionProposal`.
- [ ] **Task 3**: Refactor `EntityUpdate` for full disaggregation.
- [ ] **Task 4**: Implement `src_v2/core/reason.py` (Structured Reason).
