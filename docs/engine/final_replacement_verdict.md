...
The `src` engine is hereby ratified as a stable and honest replacement for the original `src` system within the defined [Final Replacement Boundary](../engine/final_replacement_boundary.md).
