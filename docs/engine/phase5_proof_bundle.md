...
| :--- | :--- | :--- |
| **Grid Movement** | [movement_oracle/results.json](../../tests/parity/movement_oracle/results.json) | `tests/parity/test_movement_parity.py` |
| **Resource Interaction**| [interaction_oracle/results.json](../../tests/parity/interaction_oracle/results.json) | `tests/parity/test_resource_interaction_parity.py` |
| **Town Resolution** | [town_oracle/results.json](../../tests/parity/town_oracle/results.json) | `tests/parity/test_town_resolution_parity.py` |
