...
- **Replacement Ledger**: [legacy_replacement_ledger.md](legacy_replacement_ledger.md) (Ratified through Phase 12)
- **Retirement Manifest**: [phase13_retirement_manifest.md](phase13_retirement_manifest.md)
- **Closure Report**: [phase12_closure_report.md](phase12_closure_report.md)
