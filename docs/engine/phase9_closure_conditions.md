...
- **Proof**: `tests_v2/strategic/test_event_interpretation.py::test_strategic_pivot_on_danger`
...
- **Proof**: `tests_v2/strategic/test_event_interpretation.py::test_scar_detection`
...
- **Proof**: `tests_v2/social/test_betrayal_consequence.py::test_betrayal_adds_avenge_directive`
...
- **Proof**: `tests_v2/social/test_source_trust.py::test_refutation_drops_trust`
...
- **Proof**: `tests_v2/cognition/test_knowledge_uncertainty.py::test_contradiction_degrades_certainty`
...
- **Proof**: `tests_v2/progression/test_quest_generation.py::test_quest_from_scar`
...
- **Proof**: `tests_v2/progression/test_genetics.py::test_talent_multipliers`
...
- **Proof**: `tests_v2/progression/test_skill_scaling.py::test_type_scaling`
...
- **Proof**: `tests_v2/cognition/test_belief_cycle.py::test_belief_decay_and_rumor_certainty`
...
- **Proof**: `tests_v2/cognition/test_narrative_memory.py::test_turning_point_persistence`

## Atomic Checklist Closure Conditions

Each unchecked item in Part 1 §Strategic and §Social is closed when:
1. The corresponding logic exists in `src_v2/` with typed models.
2. At least one contract test in `tests_v2/` validates the behavior.
