...
- [x] Entities initialize with correct aspects. <!-- COMPLETED: src/core/builder.py -->
- [x] Registries load deterministically. <!-- COMPLETED: src/core/classes.py -->
- [x] RNG domain separation works. <!-- COMPLETED: src/platform/rng.py (Enhanced) -->
- [x] Spawn/loadout data is data-driven. <!-- COMPLETED: src/systems/generator.py -->
- [x] Entity copy/serialization preserves gameplay state. <!-- COMPLETED: src/core/serialization.py -->
...
- [x] Default entity has valid required aspects.
- [x] Hero has hero role, faction, class, inventory, and progression state.
- [x] Monster has tier, faction, leash/home behavior fields.
- [x] Builder output is deterministic for same seed.
- [x] Builder-created entity can serialize and deep-copy safely.
<!-- COMPLETED: Verified in tests/entities/test_entity_builder_contract.py -->
...
- [x] All core registry files load.
- [x] Duplicate IDs fail loudly.
- [x] Missing references fail loudly.
- [x] Class skill IDs resolve.
- [x] Spawn configs reference valid loadouts.
- [x] Loot tables reference valid item IDs.
<!-- COMPLETED: Verified in tests/registry/test_registry_loading.py -->
...
- [x] Same seed/domain/entity/tick gives same result.
- [x] Different domains produce different streams.
- [x] `next_int` respects inclusive bounds.
- [x] RNG use is not based on global Python randomness.
- [x] Replay-visible state is stable under same seed.
<!-- COMPLETED: Verified in tests/platform/test_rng_contract.py -->
...
- [x] Insert places entity in correct cell.
- [x] Move removes old cell membership.
- [x] Remove clears membership.
- [x] Radius query includes neighboring cells.
- [x] Query result ordering is deterministic.
<!-- COMPLETED: Verified in tests/platform/test_spatial_hash_contract.py -->
...
- [x] Snapshot entities are deep copied.
- [x] Frozen state rejects mutation.
- [x] Serialization round-trip preserves gameplay fields.
- [x] Nested collections are not shared.
- [x] AI cannot mutate authoritative state through snapshot references.
<!-- COMPLETED: Verified in tests/core/test_snapshot_isolation.py -->
