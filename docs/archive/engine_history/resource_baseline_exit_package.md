...
- **[Truth Package](../engine_history/resource_truth_package.md)**: Master index of all divergences and limitations.
- **[Divergence Log](../../engine/divergence_log.md)**: Record of intentional shifts from legacy behavior.
- **[Proof Bundle](../engine_history/resource_proof_bundle.md)**: Discoverable index of all parity and contract evidence.
- **[Support Boundary](../engine_history/resource_exit_support_boundary.md)**: The restated "Official Support" surface.
