...
| :--- | :--- | :--- |
| `tests/tactical/` | Pursuit, Retreat, Stickiness, Stalemate | PASS |
| `tests/world/` | Terrain, Buildings, LoS | PASS |
| `tests/combat/` | Authoritative Resolution | PASS |

### 2.3 Differential Parity Proofs
- [Combat Parity Proof](file:///home/vboxuser/Work/rpg-based-simulation/tests/parity/test_combat_parity.py)
