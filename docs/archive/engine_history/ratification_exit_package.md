...
| :--- | :--- | :--- |
| **Replacement Verdict** | Authoritative claim statement. | [RATIFIED](../engine_ledger/final_replacement_verdict.md) |
| **Replacement Boundary** | Explicit scope definition. | [RATIFIED](../engine_ledger/final_replacement_boundary.md) |
| **Replacement Ledger** | Row-level evidence record. | [RATIFIED](../engine_ledger/legacy_replacement_ledger.md) |
| **Proof Bundle** | Consolidated evidence links. | [RATIFIED](../engine_history/ratification_proof_bundle.md) |

## 2. Phase 12 Cutover Baseline

| Artifact | Purpose | Status |
| :--- | :--- | :--- |
| **Allowed Surface** | What Phase 12 may cut over. | [BOUNDED](../engine_history/cutover_allowed_surface.md) |
| **Cutover Constraints** | Caveats and forbidden assumptions. | [BOUNDED](../engine_history/cutover_constraints.md) |
