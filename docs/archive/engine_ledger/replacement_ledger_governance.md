...
This document defines the formal rules for managing the [Authoritative Replacement Ledger](../engine_ledger/legacy_replacement_ledger.md) across all future phases of the engine transition.
...
- The [Maturity Snapshot](../engine_ledger/legacy_replacement_ledger.md) (Totals).
- The [Remaining Replacement Scope](../engine_ledger/remaining_replacement_scope.md) (if phase or count changes).
- The [Audit Log](../engine_ledger/legacy_replacement_ledger.md).
