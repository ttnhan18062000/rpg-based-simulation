...
| **Strategic** | Phase 9 | [PH9 Entry](../engine_history/strategy_social_entry_support_boundary.md) | `test_recruitment.py` | `test_resource_intelligence_contract.py` | **HARDENED** |
| **Legality** | Phase 10 | [PH10 Entry](../engine_history/infrastructure_entry_support_boundary.md) | `test_legality.py` | `test_legality.py` | **HARDENED** |
| **Compatibility**| Phase 10 | [PH10 Entry](../engine_history/infrastructure_entry_support_boundary.md) | `test_entry_parity.py` | `test_infra_isolation.py` | **HARDENED** |
| **Observability**| Phase 10 | [PH10 Entry](../engine_history/infrastructure_entry_support_boundary.md) | `test_observability.py` | `test_observability.py` | **HARDENED** |
