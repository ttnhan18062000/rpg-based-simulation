...
- **Reference**: [Final Replacement Boundary](../engine_ledger/final_replacement_boundary.md)
...
- **Reference**: [Final Proof Bundle](../engine_history/ratification_proof_bundle.md)

### Combat & Action
- **Status**: ~85% (Hardened)
- **Status Detail**: Basic combat resolution, legality enforcement (LoS), and action convergence are fully recovered.
- **Reference**: [Final Replacement Verdict](../engine_ledger/final_replacement_verdict.md)

### Strategic & Social
- **Status**: 100% (Ratified)
- **Status Detail**: Bounded cognition, social trust, and project-based AI are fully recovered and hardened.
- **Reference**: [Strategic Cognition Baseline](../engine_history/ratification_preserved_review.md)
...
- **Verdict**: [Final Replacement Verdict](../engine_ledger/final_replacement_verdict.md) — RATIFIED.
- **Policy**: No implied parity; only verified behaviors in the [Legacy Replacement Ledger](../engine_ledger/legacy_replacement_ledger.md) are supported.
