...
| **lifecycle** | `LifecycleComponent`, `state.py:152-195` | `age_ticks`, `max_age_ticks`, `is_permadeath`, `death_tick`, `death_reason`, `generation`, `heir_entity_id`, `heirlooms`, `parent_a_entity_id`, `parent_b_entity_id`, `dependent_entity_ids`, `birth_tick`, `birth_city_id`, `reproduction_cooldowns`, `active`, `genetic_profile` |
