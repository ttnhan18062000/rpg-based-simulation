...
- `docs/engine/supported_gameplay_surface_m5.md`
- support boundary docs
- certification claim-scope docs
- milestone review docs

#### [Task important notes]

This matrix is the truth surface, not a planning wishlist.

#### [Task check list]

- [ ] Supported gameplay slices are listed explicitly
- [ ] Supported execution modes are listed explicitly
- [ ] Supported profile scope is listed explicitly
- [ ] Lifecycle guarantees are listed explicitly
- [ ] Preserved semantics and divergences are listed explicitly
- [ ] Unsupported or future-scope behavior is listed explicitly
...
- gameplay certification tests
- certification matrix docs

#### [Task important notes]

Do not expand certification breadth faster than the supported gameplay surface itself.

#### [Task check list]

- [ ] Movement certification scenarios exist
- [ ] Resource interaction certification scenarios exist
- [ ] Integrated gameplay certification scenarios exist
- [ ] Execution-mode certification scenarios exist where needed
- [ ] Lifecycle-relevant gameplay certification scenarios exist where needed
...
- performance harness
- benchmark CI/reporting
- performance docs

#### [Task important notes]

Do not benchmark speculative gameplay that is not officially supported yet.

#### [Task check list]

- [ ] Movement gameplay benchmarks exist
- [ ] Resource interaction benchmarks exist
- [ ] Integrated gameplay benchmarks exist
- [ ] Execution-mode benchmark variants exist where relevant
- [ ] Results remain scoped and reproducible
...
- proof bundle docs
- release-gate docs
- recorder/report docs

#### [Task important notes]

Do not let gameplay support remain invisible to release truth once it is declared official.

#### [Task check list]

- [ ] Gameplay proof is represented in release targets
- [ ] Required artifacts cover supported gameplay scenarios
- [ ] Final-gate logic reflects supported gameplay truth
- [ ] Docs reflect updated release truth
- [ ] Unsupported gameplay is not implied by release proof
...
This is exactly where teams start lying accidentally.
Keep the claim surface narrow and literal.

#### [Task check list]

- [ ] Gameplay claim scope is explicit
- [ ] Scenario/profile/hardware conditions are explicit
- [ ] Preserved semantics and divergences are explicit
- [ ] Unsupported areas are explicit
- [ ] Reports stay scoped and non-universal
- [ ] Proof/report language matches the support matrix
...
This milestone fails if the supported gameplay surface can still drift silently.

#### [Task check list]

- [ ] Parity drift is guarded where needed
- [ ] Determinism drift is guarded
- [ ] Lifecycle drift is guarded
- [ ] Support-boundary drift is guarded
- [ ] Proof/report/release drift is guarded
...
### [ ] (checkbox) - [Task 7] - Publish the supported-surface package: support matrix, boundaries, known limitations, and claim scope
...
- `docs/engine/supported_surface_package_m5.md`
- support matrix docs
- benchmark docs
- certification docs
- release docs
...
- [ ] Support matrix is included
- [ ] Support boundaries are included
- [ ] Lifecycle guarantees are included
- [ ] Benchmark/certification claim scope is included
- [ ] Preserved semantics and divergences are included
