...
1. TCK-20260824-ALLOCATE-AP-BRANCH-DECISION  (no deps in this batch)
2. TCK-20260824-BREAKTHROUGH-BONUS-APPLICATION  (no deps in this batch)
3. TCK-20260824-CAUSAL-MEMORY-ROUTE-SCORING  (depends on: TCK-20260824-WIRE-ORPHANED-MECHANISMS)
4. TCK-20260824-DEFAULT-HEIR-ASSIGNMENT  (no deps in this batch)
5. TCK-20260824-GRIEF-NEMESIS-REACHABILITY  (no deps in this batch)
6. TCK-20260824-LEAD-CONTRADICTION-WIRING  (no deps in this batch)
7. TCK-20260824-LIFE-STAGE-TRANSITIONS  (no deps in this batch)
8. TCK-20260824-NEMESIS-MEMORY-UNIT-TESTS  (no deps in this batch)
9. TCK-20260824-OCCUPATION-CHANGE-TRIGGER  (no deps in this batch)
10. TCK-20260824-RELATIONSHIP-ROLE-FIELD  (no deps in this batch)
11. TCK-20260824-ROLLOUT-FLAG-DECISIONS  (no deps in this batch)
