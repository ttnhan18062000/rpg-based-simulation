# Implementation Sequence — mechanism-system-membership
...
order. `TCK-20260918-EPIC-MECHANISM-SYSTEM-MEMBERSHIP` is the epic-tier parent and is not implemented
directly — it tracks the children below.

## Order

1. TCK-20260918-MECHANISM-SYSTEM-MEMBERSHIP-VALUE-INVESTIGATION  (no deps in this batch)
...
hand-maintaining membership across 93 mechanisms with no mechanical backing.
...
*collaboration*. Declared membership does not consult edges at all, which removes all three blockers the
