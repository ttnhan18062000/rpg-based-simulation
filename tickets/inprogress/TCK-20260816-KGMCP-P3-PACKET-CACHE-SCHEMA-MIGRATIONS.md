...
required no correction. AC for the parity ledger entry is now satisfied; this ticket's own
`## Status` moved from OPEN to INPROGRESS since Verify/Finalize phases remain per the standard-tier
10-phase pipeline.
