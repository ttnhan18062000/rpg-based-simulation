...
## Scope
- [x] Task 1: Audit legacy CLI and entrypoint rows against current `src` entry behavior.
...
## Acceptance Criteria
- `python3 -m src cli` works with legacy flags.
...
## Test Summary
- `tests/cli/test_entry_parity.py` (4 tests passed).

## Files Changed
- `src/__main__.py` [NEW]
- `src/cli/entry.py` [NEW]
- `src/systems/generator.py` [NEW]
- `tests/cli/test_entry_parity.py` [NEW]
