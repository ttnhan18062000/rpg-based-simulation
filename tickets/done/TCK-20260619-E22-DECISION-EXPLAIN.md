...
## Files Changed
- `tickets/todos/TCK-20260619-E22A-TRACE-WRITER.md` (new)
- `tickets/todos/TCK-20260619-E22B-TICK-INDEX.md` (new)
- `tickets/todos/TCK-20260619-E22C-REST-API.md` (new)
- `staging_artifacts/TCK-20260619-E22-DECISION-EXPLAIN/investigation.md` (new)
- `staging_artifacts/TCK-20260619-E22-DECISION-EXPLAIN/plan.md` (new)
- `staging_artifacts/TCK-20260619-E22-DECISION-EXPLAIN/test_plan.md` (new)

## Completion Summary
EPIC_SCOPED 2026-06-20. Scoped into 3 child tickets. Investigation confirmed: cognition_graph_snapshots.jsonl is DEBUG/CERTIFICATION only (LIGHT mode skips snapshots). No decision_trace.jsonl or /decisions REST endpoint exists. API route pattern found at src/api/routes/ (behavior.py, state.py etc.). execute_brain() at src/engine/domain/cognition.py is where trace data is computed and currently discarded.
