"""Minimal, dependency-free PNG encoder — proves batch rendering needs zero new pip packages.

Not production code. Prototype only, for experiments/spatial_rendering/'s brainstorm.
"""
