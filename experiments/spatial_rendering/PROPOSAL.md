...
- **Corpus-wide fill-ratio sweep, 3 worlds → all 18 (§5c follow-up):** 21 of 26 measured components score ≥0.95 — the rectangle-stamping pattern is project-wide, not a `dungeon_crawl` artifact. The one statistical outlier (0.584) was rendered and inspected directly rather than reported at face value: it's an L-shaped composite of multiple rectangular stamps joined together, not organic terrain. **There is no genuinely organic biome shape anywhere in this project's current world corpus.**
