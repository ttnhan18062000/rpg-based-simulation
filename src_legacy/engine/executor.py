...
if TYPE_CHECKING:
    from src_legacy.core.work import WorkItem
    ...
    def execute(
        ...
        for i, item in enumerate(work_items):
            ...
            # 2. SYSTEM DEFERRED WORK (Milestone C: De-simulation)
                ...
                from src_legacy.engine.domain_logic import SimulationDomainLogic
                from src_legacy.core.concurrency_law import ConcurrencyLaw
                from src_legacy.core.updates import EntityUpdate
...
class ConcurrentExecutionAdapter:
    ...
    def execute(
        ...
        from src_legacy.engine.worker_logic import default_simulation_worker
