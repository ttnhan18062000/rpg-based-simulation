...
from src_legacy.actions.base import ActionProposal, BuildingUpdate
...
from src_legacy.actions.repair import RepairAction
...
class ConflictResolver:
    ...
    def _sort(cls, proposals: list[ActionProposal], world: WorldState) -> list[ActionProposal]:
        ...
        from src_legacy.core.logic.movement_model import INTENTION_PRIORITY
    ...
    def _apply_one(
        ...
        from src_legacy.utils.metrics import SIM_INVALID_ACTIONS_TOTAL
