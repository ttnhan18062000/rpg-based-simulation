...
from src_legacy.engine.replay_buffer import ReplayBuffer
from src_legacy.engine.replay_sink import ReplaySink
...
class ReplayManager:
    ...
    def __init__(
        ...
        from src_legacy.core.retention import OverflowPolicy
    ...
    def finalize(self, timeout_s: float = 5.0) -> LifecycleOutcome:
        ...
        """
        from src_legacy.core.lifecycle import LifecycleOutcome
