...
from src_legacy.engine.phases import get_authoritative_phases
from src_legacy.core.updates import StateUpdate, EntityUpdate
from src_legacy.core.governance import PressureSignals, RuntimeMode
from src_legacy.core.diagnostic import TraceEvent
from src_legacy.core.lifecycle import LifecycleOutcome, ShutdownResult

from src_legacy.engine.executor import IWorkExecutor, LocalSequentialExecutor, ConcurrentExecutionAdapter
...
if TYPE_CHECKING:
    ...
    from src_legacy.engine.scheduler import DeterministicScheduler
    from src_legacy.engine.governor import ResourceGovernor
...
class Kernel:
    ...
    def __init__(
        ...
        from src_legacy.engine.scheduler import DeterministicScheduler as DefaultScheduler
        from src_legacy.engine.governor import ResourceGovernor as DefaultGovernor
        from src_legacy.engine.runtime_status import RuntimeStatus as DefaultStatus
        from src_legacy.engine.replay_manager import ReplayManager as DefaultReplayManager
        from src_legacy.engine.observability import SignalCollector
    ...
    def validate(self, flags: Optional[Dict[str, bool]] = None) -> None:
        from src_legacy.config.validator import ProfileValidator
    ...
    def _phase_collection(self) -> None:
        ...
        from src_legacy.core.protocol_validator import ProtocolValidator
    ...
    def _phase_resolution(self) -> None:
        ...
        from src_legacy.core.worker_protocol import ResultStatus
        from src_legacy.core.updates import StateUpdate, EntityUpdate
