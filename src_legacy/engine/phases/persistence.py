...
from src_legacy.api.kafka_client import get_kafka_producer, KAFKA_TOPIC_EVENTS, KAFKA_TOPIC_SNAPSHOTS
from src_legacy.utils.metrics import SIM_KAFKA_PUBLISH_DURATION
...
class PersistencePhase(EnginePhase):
    ...
    def execute(self, ctx: EngineContext) -> None:
        ...
        from src_legacy.api.redis_client import is_redis_disabled, get_sync_redis
        from src_legacy.api.kafka_client import is_kafka_disabled, get_kafka_producer
        ...
        if not is_redis_disabled():
            try:
                ...
                if r:
                    ...
                    import json
                    from src_legacy.utils.serialization import SimulationJSONEncoder
