...
from src_legacy.core.models.enums import AIState, ActionType, GoalType, EmotionType, Domain, StrategicStatus
from src_legacy.ai.tactical.tactical_evaluator import TacticalEvaluator
from src_legacy.core.models.strategy import StrategicStatus, DecisionDriver
from src_legacy.actions.base import (
...
from src_legacy.ai.goals import GoalEvaluator
from src_legacy.ai.perception import Perception
from src_legacy.ai.states import AIContext, STATE_HANDLERS, IdleHandler
...
from src_legacy.ai.strategy.candidate_builder import StrategicCandidateBuilder
from src_legacy.ai.strategy.strategic_evaluator import StrategicEvaluator
from src_legacy.ai.strategy.objective_to_goal_mapper import ObjectiveToGoalMapper
from src_legacy.core.models.strategy import ObjectiveKind # [PHASE 3]
from src_legacy.ai.cognition_capacity import CognitionCapacityBuilder
from src_legacy.ai.strategic_bounded_appraisal import BoundedStrategicAppraisalService, StrategicDecisionOutcome
...
class AIBrain:
    ...
    def __init__(
        ...
        from src_legacy.ai.goals.registry import register_all_goals
        register_all_goals()
    ...
    def _sensory_perception_phase(self, actor: Entity, snapshot: Snapshot, updates: list[IntentUpdate]) -> tuple[AIContext, dict[GoalType, float]]:
        ...
        from src_legacy.core.aspects.mind import SocialStance
    ...
    def _strategic_appraisal_phase(self, actor: Entity, snapshot: Snapshot, updates: list[IntentUpdate], ctx: AIContext) -> str | None:
        ...
        from src_legacy.core.logic.world_consequence_interpretation import WorldConsequenceInterpretationService
        from src_legacy.core.logic.strategic_event_interpreter import StrategicEventInterpreter
        ...
        from src_legacy.ai.strategy.strategic_evaluator import StrategicDecision
        from src_legacy.ai.strategy.objective_derivation import ObjectiveDerivationService
        from src_legacy.ai.strategy.blocker_inference import BlockerInferenceService
        from src_legacy.ai.strategy.detour_suggestion import DetourSuggestionService
        ...
        from src_legacy.core.aspects.mind import DecisionDriver
    ...
    def _memory_appraisal_phase(self, ctx: AIContext, updates: list[IntentUpdate], social_biases: dict[GoalType, float], strategic_objective_id: str | None = None) -> None:
        ...
        from src_legacy.ai.states.base import get_perception_cleanup_update
        ...
        if rid:
            ...
            if rid not in mind.narrative.memory_locations:
                from src_legacy.core.aspects.mind import MemoryLogEntry, DiscoveryNarrative
        ...
        if snapshot.tick - last_appraisal >= 10:
            from src_legacy.core.aspects.mind import PersonalMotive
            ...
            from src_legacy.core.models.enums import LifeRole
