...
from src_legacy.core.models.strategy import StrategicStatus, ProjectRecord, ConcernRecord
from src_legacy.actions.base import StrategicUpdate

if TYPE_CHECKING:
    from src_legacy.ai.states.base import AIContext
    from src_legacy.ai.strategy.candidate_builder import StrategicCandidate
...
class StrategicEvaluator:
    ...
    def __init__(self):
        ...
        from src_legacy.ai.strategy.interruption import StrategicInterruptionService
