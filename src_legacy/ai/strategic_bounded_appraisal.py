...
from src_legacy.core.models.strategy import StrategicStatus, ProjectRecord, ProjectKind, ConcernRecord, ObligationRecord, LeadRecord, BlockerRecord, SocialContractRecord, ObjectiveRecord, OfferStatus
