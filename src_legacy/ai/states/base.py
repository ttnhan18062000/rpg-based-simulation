...
from src_legacy.actions.base import ActionProposal, IntentUpdate
from src_legacy.ai.perception import Perception
from src_legacy.core.models.enums import AIState, ActionType, Domain, HeroClass, GoalType, MovementIntention
...
if TYPE_CHECKING:
    ...
    from src_legacy.core.aspects.mind import BeliefRecord, InterpretedEvent
...
def _greedy_move_toward(actor: Entity, target_pos: Vector2, snapshot: Snapshot, reason: str, updates: list[IntentUpdate] | None = None) -> ActionProposal:
    ...
    from src_legacy.core.models.enums import MovementIntention
