...
from src_legacy.core.gameplay.buildings import (
...
from src_legacy.core.gameplay.items.items import ItemType, _item_power
...
class VisitGuildHandler(StateHandler):
    def handle(self, ctx: AIContext) -> tuple[AIState, ActionProposal]:
        ...
        from src_legacy.core.gameplay.quests import generate_quest, MAX_ACTIVE_QUESTS
...
class VisitInnHandler(StateHandler):
    def handle(self, ctx: AIContext) -> tuple[AIState, ActionProposal]:
        ...
        from src_legacy.core.gameplay.effects import well_rested_effect
