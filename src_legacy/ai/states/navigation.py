...
from src_legacy.actions.base import ActionType, ActionProposal
from src_legacy.ai.perception import Perception
from src_legacy.core.models.enums import AIState, Domain
from src_legacy.core.gameplay.faction import Faction
from src_legacy.core.models import DIRECTION_OFFSETS, Vector2
...
from src_legacy.core.models.enums import HeroClass, LeadKind, MovementIntention
    ...
    def handle(self, ctx: AIContext) -> tuple[AIState, ActionProposal]:
        ...
        if actor.identity.faction == Faction.HERO_GUILD:
            ...
            if actor.inventory and actor.inventory.used_slots < actor.inventory.max_slots - 1:
                ...
                from src_legacy.ai.states.interaction import find_nearby_resource
        ...
        if enemy is not None:
            ...
            from src_legacy.ai.states.combat import get_weapon_range
            weapon_rng = get_weapon_range(actor)
            
            if dist <= weapon_rng:
                from src_legacy.ai.states.combat import best_ready_skill
...
class InvestigateHandler(StateHandler):
    ...
    """
    def handle(self, ctx: AIContext) -> tuple[AIState, ActionProposal]:
        from src_legacy.core.models.strategy import ObjectiveKind, ProjectRecord
