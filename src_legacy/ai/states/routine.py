...
from src_legacy.core.models.enums import AIState, ActionType, MovementIntention
from src_legacy.actions.base import ActionProposal, RoutineUpdate
from src_legacy.ai.states.base import StateHandler, AIContext
    ...
    def handle(self, ctx: AIContext) -> tuple[AIState, ActionProposal]:
        ...
        if target_pos:
            ...
            if dist > 0:
                ...
                from src_legacy.ai.states.base import propose_move_toward
