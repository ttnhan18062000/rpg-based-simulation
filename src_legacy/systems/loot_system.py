...
from src_legacy.core.updates import StateUpdate, EntityUpdate, InteractionUpdate, InventoryUpdate
    ...
    def update(state: AuthoritativeState) -> StateUpdate:
        ...
        for entity in state.entities.values():
            ...
            if new_progress >= required:
                ...
                if not InventoryService.can_add_items(entity.inventory, items_to_add):
