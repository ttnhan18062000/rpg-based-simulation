...
from src_legacy.core.state import AuthoritativeState, ItemStack
from src_legacy.core.updates import StateUpdate, EntityUpdate, InteractionUpdate, InventoryUpdate, ResourceNodeUpdate
    ...
    def update(state: AuthoritativeState) -> StateUpdate:
        ...
        for entity in state.entities.values():
            ...
            if new_progress >= required:
                ...
                if not InventoryService.can_add_item(entity.inventory, yield_item, 1):
