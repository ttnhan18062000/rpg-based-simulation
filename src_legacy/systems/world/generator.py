...
from src_legacy.core.gameplay.classes import mob_class_for
from src_legacy.core.entities.entity_builder import EntityBuilder
from src_legacy.core.models.enums import AIState, Domain, EnemyTier, RACE_PROFILES
...
from src_legacy.core.world.spawn_config import SPAWN_CONFIGS, LOOT_CONFIGS
...
from src_legacy.core.models.enums import LifeRole # [PHASE 3]
...
class EntityGenerator:
    ...
    def equip_entity(self, entity: Entity) -> None:
        ...
        from src_legacy.core.gameplay.items.items import RACE_STARTING_GEAR, TIER_STARTING_GEAR
    ...
    def spawn_calamity(self, world: WorldState, template_id: str) -> Entity:
        ...
        from src_legacy.core.models.calamities import CALAMITY_TEMPLATES
        from src_legacy.core.models.enums import Domain, EntityRole
    ...
    def _build_race_inventory(
        ...
        if loot_cfg:
            from src_legacy.core.gameplay.items.items import DIFFICULTY_DROP_MULTIPLIER
