...
from src_legacy.core.models.enums import LifeRole, Archetype, Faction, AttachmentKind, GoalType
from src_legacy.core.models.lived_structure import RoutineProfile, PlaceAttachment
