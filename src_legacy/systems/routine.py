...
from src_legacy.core.strategic import ConcernState
from src_legacy.core.models.enums import ReasonCode
...
class RoutineService:
    ...
    def evaluate_biological_needs(entity: EntityState, world_time: int) -> List[ConcernState]:
        ...
        # 2. Sleep
        # Sleep bias increases at night (e.g. world_time 1800 to 0600)
        is_night = (world_time >= 1800 or world_time < 600)
        sleep_urgency = bio.sleep_debt / 100.0
        if is_night:
            sleep_urgency += 0.3 # Night bonus
