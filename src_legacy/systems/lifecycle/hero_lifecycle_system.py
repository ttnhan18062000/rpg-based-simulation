...
from src_legacy.core.models.enums import AIState, ItemType, Domain
from src_legacy.core.gameplay.faction import Faction
from src_legacy.core.world.monuments import Monument
from src_legacy.core.models.history import HistoricalEvent, EventKind # [PHASE 4]
from src_legacy.core.models.continuity import SuccessorRecord # [PHASE 4]
from src_legacy.core.models.strategy import DirectiveKind # [PHASE 1 STAGE 13]
    ...
    def process_hero_death(self, ctx: SystemContext, entity, tick: int) -> bool:
        ...
        if is_permadeath:
            ...
            if entity.inventory and household:
                ...
                heirlooms = []
                remaining = []
                from src_legacy.core.gameplay.items.item_registry import ITEM_REGISTRY, Rarity
            ...
            if tick >= rep["tick"]:
                ...
                if household_id and household_id in ctx.world.household_registry:
                    ...
                    if inherited_directives:
                        from src_legacy.core.models.strategy import DirectiveRecord
