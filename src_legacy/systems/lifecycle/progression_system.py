...
from src_legacy.core.models.enums import AIState
...
class ProgressionSystem(System):
    ...
    def _handle_stat_decay(self, context: SystemContext) -> None:
        ...
        from src_legacy.core.gameplay.attributes import decay_attributes
    ...
    def _check_level_ups(self, context: SystemContext) -> None:
        ...
        from src_legacy.core.models.enums import RACE_PROFILES
        from src_legacy.core.gameplay.attributes import recalc_derived_stats
        ...
        for entity in world.entities.values():
            ...
            while prog.xp >= prog.xp_to_next and prog.level < max_level:
                ...
                if entity.progression.attributes:
                    from src_legacy.core.gameplay.attributes import recalc_derived_stats as _recalc, check_breakthroughs
                ...
                if hasattr(world, "event_bus") and world.event_bus:
                    from src_legacy.core.data.events import LevelUpEvent
    ...
    def _evolve_entity(self, context: SystemContext, entity: Any, profile: Any) -> None:
        ...
        from src_legacy.core.gameplay.items.items import TIER_KIND_NAMES, RACE_TIER_KINDS, RACE_STARTING_GEAR, TIER_STARTING_GEAR
        from src_legacy.core.gameplay.attributes import recalc_derived_stats
