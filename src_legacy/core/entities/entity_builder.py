...
from src_legacy.core.models.enums import AIState, EntityRole, Domain, Archetype, LifeRole # [PHASE 3]
...
from src_legacy.core.gameplay.classes import CLASS_DEFS, RACE_SKILLS, SkillInstance, available_class_skills, SKILL_DEFS
...
class EntityBuilder:
    ...
    def with_traits(self, race_prefix: str = "", trait_ids: list[str | int] | None = None) -> EntityBuilder:
        from src_legacy.core.entities.traits import assign_traits
        if trait_ids:
    ...
    def _seed_lived_structures(self, entity: Entity, mind: MindAspect):
        ...
        from src_legacy.systems.social_legacy.lived_structure_service import LivedStructureService
