...
import logging
from src_legacy.core.models.enums import Domain, EnemyTier, EntityRole, Material
...
from src_legacy.core.models.world_objects import TreasureChest
from src_legacy.core.gameplay.buildings import Building
from src_legacy.core.models.world_state import WorldState
from src_legacy.core.world.regions import (
    Region, Location, LOCATION_NAME_TEMPLATES, TERRAIN_RACE_LABEL,
    difficulty_for_distance, pick_region_name, reset_name_counters,
)
from src_legacy.core.world.resource_nodes import ResourceNode, TERRAIN_RESOURCES
from src_legacy.core.gameplay.items.items import TERRAIN_RACE
...
class WorldGenerator:
    ...
    def generate(self) -> tuple[WorldState, EntityGenerator]:
        ...
        from src_legacy.systems.world.terrain_detail import TerrainDetailGenerator
    ...
    def _spawn_initial_entities(self, world, generator: EntityGenerator, cfg, rng: DeterministicRNG, town_center: Vector2):
        from src_legacy.core.gameplay.classes import HeroClass, HERO_STARTING_GEAR
        from src_legacy.core.entities.entity_builder import EntityBuilder
        from src_legacy.core.data.hero_names import generate_hero_name
