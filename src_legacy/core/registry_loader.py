...
from src_legacy.core.classes import ClassDef, BreakthroughDef, SkillDef, CLASS_DEFS, BREAKTHROUGHS, SKILL_DEFS
from src_legacy.core.traits import TraitDef, TRAIT_DEFS
from src_legacy.core.world.spawn_config import SpawnConfig, SPAWN_CONFIGS, LootConfig, LOOT_CONFIGS
