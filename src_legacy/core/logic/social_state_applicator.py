...
from src_legacy.core.logic.turning_points import TurningPointService
...
if TYPE_CHECKING:
    ...
    from src_legacy.actions.base import SocialUpdate, ReputationUpdate, IntentUpdate
...
class SocialStateApplicator:
    ...
    def _map_event_to_tp_kind(event_kind: int) -> TurningPointKind:
        ...
        from src_legacy.core.models.enums import InterpretedLifeEventKind
