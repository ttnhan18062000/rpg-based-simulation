...
from src_legacy.core.models.enums import InterpretedLifeEventKind, EnemyTier, EntityRole, Domain
...
if TYPE_CHECKING:
    ...
    from src_legacy.core.models.combat import CombatTraceRecord
