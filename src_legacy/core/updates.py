...
if TYPE_CHECKING:
    from src_legacy.core.state import GroupRecord, ItemStack, EquipSlot, AttributeComponent, LocalScarState, ChestState, EntityState
    from src_legacy.core.quests import QuestStatus
...
from src_legacy.core.state import ItemStack, EquipSlot, AttributeComponent
...
class NavigationUpdate:
    ...
    mode_set: Optional[MovementMode] = None
