...
from src_legacy.core.gameplay.items.item_registry import ItemTemplate, ITEM_REGISTRY
from src_legacy.core.gameplay.classes import ClassDef, BreakthroughDef, SkillDef, CLASS_DEFS, BREAKTHROUGHS, SKILL_DEFS
from src_legacy.core.entities.traits import TraitDef, TRAIT_DEFS
from src_legacy.core.models.enums import RaceProfile, RACE_PROFILES
from src_legacy.core.world.spawn_config import SpawnConfig, LootConfig, SPAWN_CONFIGS, LOOT_CONFIGS
