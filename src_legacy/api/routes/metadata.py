...
from src_legacy.api.presenters.entity_presenter import ENTITY_KEY_MAP, STATE_ENUM_MAP

from src_legacy.core.models.enums import (
    AIState, DamageType, Element, EnemyTier, EntityRole,
    ItemType, Material, Rarity,
)
from src_legacy.core.gameplay.faction import Faction, FactionRelation, FactionRegistry
...
from src_legacy.core.gameplay.buildings import RECIPES
from src_legacy.core.world.resource_nodes import TERRAIN_RESOURCES
