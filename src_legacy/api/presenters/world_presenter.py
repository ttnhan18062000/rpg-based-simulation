...
if TYPE_CHECKING:
    ...
    from src_legacy.api.schemas import WorldStateResponse, StaticDataResponse, EventSchema
...
class WorldPresenter:
    ...
    def to_world_state_response(
        ...
        from src_legacy.api.presenters.event_presenter import EventPresenter
