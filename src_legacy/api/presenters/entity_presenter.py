...
if TYPE_CHECKING:
    ...
    from src_legacy.api.schemas import (
...
class EntityPresenter:
    ...
    def to_inspection_schema(entity: "Entity", loot_duration: int = 3, registry: Any = None, world: Any = None) -> "EntityInspectionSchema":
        ...
        from src_legacy.api.presenters.stat_breakdown import StatBreakdownService
    ...
    def to_slim_schema(entity: "Entity", loot_duration: int = 3) -> "EntitySlimSchema":
        from src_legacy.api.schemas import EntitySlimSchema
    ...
    def to_full_schema(entity: "Entity", loot_duration: int = 3, registry: Any = None, world: Any = None) -> "EntitySchema":
        ...
        from src_legacy.core.models.enums import Element, LifeRole
        from src_legacy.api.schemas import PlaceAttachmentSchema
        from src_legacy.api.presenters.ai_presenter import AIPresenter
        ...
        return EntitySchema(
            ...
            strategy=AIPresenter.serialize_strategy(entity)
        )

    @staticmethod
    def _serialize_skill(instance: "SkillInstance") -> "SkillSchema":
        from src_legacy.api.schemas import SkillSchema
        from src_legacy.core.gameplay.classes import SKILL_DEFS, _MAGICAL_SKILLS, _SKILL_ELEMENTS
        from src_legacy.core.models.enums import Element
    ...
    def _serialize_attrs(entity: "Entity"):
        if not entity.progression or not entity.progression.attributes:
            return None
        from src_legacy.api.schemas import AttributeSchema
    ...
    def _serialize_caps(entity: "Entity"):
        if not entity.progression or not entity.progression.attribute_caps:
            return None
        from src_legacy.api.schemas import AttributeCapSchema
    ...
    def _serialize_hero_class(entity: "Entity") -> str:
        from src_legacy.core.models.enums import HeroClass
        try:
    ...
    def _serialize_social_bonds(entity: "Entity", registry: Any, world: Any = None) -> list["SocialBondSchema"]:
        from src_legacy.api.schemas import SocialBondSchema
        bonds = []
        name_map = {}
        if world:
