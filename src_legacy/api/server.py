...
from src_legacy.api.dependencies import set_engine_manager, get_engine_manager
from src_legacy.api.engine_manager import V2EngineManager
...
def create_v2_app(profile: RuntimeProfile) -> FastAPI:
    ...
    from src_legacy.api.ws import stream
    ...
    async def get_state(manager: V2EngineManager = Depends(get_engine_manager)):
        ...
        from src_legacy.api.presenters.state_presenter import StatePresenter
