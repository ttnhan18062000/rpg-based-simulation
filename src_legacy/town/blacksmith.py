...
from src_legacy.core.state import AuthoritativeState, EntityState, BuildingState, ItemStack
from src_legacy.core.updates import StateUpdate, EntityUpdate, InventoryUpdate
from src_legacy.core.recipes import RecipeRegistry, Recipe
