...
from src_legacy.certification.models import ScenarioExpectations
from src_legacy.core.state import AuthoritativeState, EntityState, ItemStack
...
class ArenaInjector:
    ...
    def build_progression_test(state: AuthoritativeState) -> AuthoritativeState:
        ...
        from src_legacy.core.state import EntityState, IdentityComponent, CombatComponent, LifecycleComponent, InventoryComponent
        from dataclasses import replace
    ...
    def build_mortality_test(state: AuthoritativeState) -> AuthoritativeState:
        ...
        from src_legacy.core.state import EntityState, IdentityComponent, CombatComponent, LifecycleComponent
        from src_legacy.core.models.enums import Faction
        from dataclasses import replace
    ...
    def build_tactical_test(state: AuthoritativeState) -> AuthoritativeState:
        ...
        from src_legacy.core.state import EntityState, IdentityComponent, CombatComponent
        from src_legacy.core.models.enums import Faction
        from dataclasses import replace
    ...
    def build_social_test(state: AuthoritativeState) -> AuthoritativeState:
        ...
        from src_legacy.core.state import EntityState, IdentityComponent, CombatComponent, SocialComponent, SocialBond
        from src_legacy.core.models.enums import Faction
        from dataclasses import replace
    ...
    def build_quest_battle(state: AuthoritativeState) -> AuthoritativeState:
        ...
        from src_legacy.core.quests import QuestState, QuestStatus, QuestKind, RewardState
    ...
    def register_all():
        ...
        from src_legacy.platform.scenarios import ScenarioRegistry
...
class GameplayInjector:
    ...
    def build_harvest_test(state: AuthoritativeState, required_ticks: int = 3) -> AuthoritativeState:
        ...
        from src_legacy.core.state import EntityState, ResourceNodeState, InteractionComponent, InventoryComponent
        from dataclasses import replace
    ...
    def build_integrated_loop(state: AuthoritativeState) -> AuthoritativeState:
        ...
        from src_legacy.core.strategic import StrategicComponent, BlockerState, LeadState
        from dataclasses import replace
...
def get_scenario_expectations(scenario_id: str) -> ScenarioExpectations:
    ...
    from src_legacy.certification.models import FailureKind
