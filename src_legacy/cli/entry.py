...
def _run_cli(args):
    # Setup logging
    from src_legacy.logging.formatter import setup_v2_logging
    ...
    state = WorldGenerator.generate_world(seed, entities_count)
...
def _run_serve(args):
    ...
    import uvicorn
    from src_legacy.api.server import create_v2_app
    from src_legacy.config.loader import ConfigLoader
