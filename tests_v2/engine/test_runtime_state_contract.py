...
from src_v2.core.export import to_export_state, StateDTO
...
def test_hotpath_purity():
    ...
    state_file = pathlib.Path("src_v2/core/state.py")
    content = state_file.read_text()
    
    assert "src_v2.core.export" not in content
    assert "src_v2.core.diagnostic" not in content
