# tests_v2/verify/test_recovery_gaps.py
import pytest
from src_v2.core.state import AuthoritativeState, EntityState, IdentityComponent, CombatComponent, RegionState, BuildingState, TaskComponent
from src_v2.core.updates import StateUpdate, EntityUpdate, IdentityUpdate, TaskUpdate
...
def test_regional_hazard_impact():
    ...
    region = RegionState(id="r1", name="Toxic Swamp", bounds=(0,0,10,10), hazard_level=0.5)
