...
from src_v2.core.state import EntityState, LifecycleComponent, AuthoritativeState, CombatComponent
from src_v2.core.updates import StateUpdate, EntityUpdate, CombatUpdate, InventoryUpdate
...
def test_succession_and_heirloom_transfer():
    ...
    assert "Excalibur" in heir_upd.inventory.items_added
...
def test_near_death_hardening_logic():
    ...
    from src_v2.core.state import IdentityComponent
    ...
    from src_v2.core.updates import TaskUpdate
