...
from src_v2.certification.models import FailureKind, HardwareClass
...
def test_governance_enum_sync():
    """
    STRICT LAW: manifest.json 'RuntimeMode' must match src_v2.core.governance.RuntimeMode.
    """
...
def test_certification_enum_sync():
    """
    STRICT LAW: manifest.json 'FailureKind' and 'HardwareClass' must match src_v2.certification.models.
    """
    manifest = load_manifest()
    monitored = manifest["monitored_terminology"]
