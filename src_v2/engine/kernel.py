...
class Kernel:
    ...
    def _phase_resolution(self) -> None:
        ...
        # Milestone 3 Law: Unified authoritative refinement pipeline
        ...
        self._state = ApplyPath.apply_generation(self._state, refined_update, next_tick, self._current_world_time)
