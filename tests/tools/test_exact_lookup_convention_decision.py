...
# this file has legitimately changed via unrelated later work since TCK-20260802-EXACT-LOOKUP-
# CONVENTION's own Implementation start (e.g. TCK-20260731-PARITY-READPATH-GATE, TCK-20260810-
# PARITY-LEDGER-WRITE-SAFETY-TOOL) — confirmed via `git log` that TCK-20260802-EXACT-LOOKUP-
# CONVENTION itself never touched it. This hash snapshot only ever validly reflected that ticket's
...
# `git log` that TCK-20260802-EXACT-LOOKUP-CONVENTION never touched tools/generate_registry.py
