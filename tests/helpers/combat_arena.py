...
Usage:
    ...
    assert arena.entity(2).stats.combat.hp < arena.entity(2).stats.combat.max_hp
"""
    ...
    def add_entity(
        ...
        *,
        ...
        if skills:
            for sname in skills:
                ...
                if sdef:
                    ...
                    print(f"ERROR_SETUP: Skill {sname} not found in registry! Have {list(SKILL_DEFS.keys())}")
        ...
        entity = Entity(
            ...
            role=EntityRole.HERO if kind == "hero" else EntityRole.MOB,
        )
