...
class TestAIRefinementE2E:
    ...
    def test_anxiety_from_trauma_zones(self):
        ...
        hero.mind.emotion.emotional_state["panic"] = 0.0
        ...
        panic = hero.mind.emotion.emotional_state.get("panic", 0.0)
    ...
    def test_position_history_stuck_resolution(self):
        ...
        assert hero.mind.emotion.emotional_state.get("stuck", 0.0) == 1.0, \
