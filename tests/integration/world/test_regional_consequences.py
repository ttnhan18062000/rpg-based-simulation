...
from src.core.models.history import HistoricalEvent, EventKind
from src.core.models.local_scars import ScarKind
...
class TestRegionalConsequences(unittest.TestCase):
    ...
    def test_ai_goal_bias_from_danger(self):
        from src.ai.goals.scorers import FleeGoal, ExploreGoal
