...
from src.core.models.enums import StrategicStatus, ProjectKind, ContractKind
from src.core.models.strategy import StrategicState, ProjectRecord, SocialContractRecord
...
class TestLeadIdempotency:
    ...
    def test_duplicate_lead_upsertion(self):
        ...
        from src.core.models.enums import LeadKind
