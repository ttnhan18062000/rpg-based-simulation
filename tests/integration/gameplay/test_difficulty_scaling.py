...
class TestSpawnDifficultyScaling(unittest.TestCase):
    ...
    def test_tier1_is_baseline(self):
        ...
        self.assertGreater(e.stats.combat.hp, 0)
        self.assertGreater(e.stats.combat.atk_base, 0)
    ...
    def test_tier4_has_higher_stats_than_tier1(self):
        ...
        self.assertGreater(e4.stats.combat.max_hp, e1.stats.combat.max_hp)
        self.assertGreater(e4.stats.combat.atk_base, e1.stats.combat.atk_base)
    ...
    def test_tier4_hp_significantly_higher(self):
        ...
        ratio = e4.stats.combat.max_hp / e1.stats.combat.max_hp
...
class TestSpawnRaceDifficultyScaling(unittest.TestCase):
    ...
    def test_race_difficulty_tier_set(self):
        ...
        self.assertEqual(e.spatial.difficulty_tier, 2)
    ...
    def test_all_races_scale(self):
        ...
        for race in ("wolf", "bandit", "undead", "orc"):
            ...
            with self.subTest(race=race):
                self.assertGreater(e3.stats.combat.max_hp, e1.stats.combat.max_hp,
