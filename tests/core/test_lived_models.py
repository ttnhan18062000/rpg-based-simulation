import pytest
from src.core.models.lived_structure import RoutineProfile, PlaceAttachment, GroupRecord
from src.core.models.enums import GoalType, GroupKind, AttachmentKind, LifeRole
