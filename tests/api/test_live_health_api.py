...
async def test_live_health_api_suite():
    ...
    try:
        ...
        resp_red1 = requests.get(url_redirect1, allow_redirects=False)
        ...
        resp_red2 = requests.get(url_redirect2, allow_redirects=False)
        ...
        res_pub1 = requests.post(url_publish, json=payload_stuck)
