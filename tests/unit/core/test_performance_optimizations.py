...
def test_entity_copy_shallow_vs_refs():
    ...
    e1.mind.terrain_memory[(0,0)] = 1
    assert (0,0) in e2.mind.terrain_memory # They share the SAME mind object (shallow copy)
    
    # This confirms it's a shallow copy as intended for the Snapshot performance.
    # Snapshots are immediate-pickle-and-discard, so shared refs are fine.
