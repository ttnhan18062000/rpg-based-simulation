...
def test_entity_stats_proxy_delegation():
    ...
    entity.combat.combat.atk_base = 10
    entity.combat.combat.def_base = 5
    
    # Check base delegation
    assert entity.stats.combat.combat.atk_base == 10
    assert entity.stats.combat.combat.def_base == 5
    
    # Test setting through stats shim
    entity.stats.combat.combat.atk_base = 20
    assert entity.combat.combat.atk_base == 20
    assert entity.stats.combat.combat.atk_base == 20
...
def test_effective_stats_with_equipment():
    ...
    assert entity.stats.combat.combat.atk_base == 15
...
def test_effective_stats_with_effects():
    ...
    assert entity.stats.combat.combat.atk_base == 12
...
def test_veterancy_multiplier():
    ...
    assert entity.stats.combat.combat.atk_base == 11
