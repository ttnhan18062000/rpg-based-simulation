...
class TestQuestGeneration:
    ...
    def test_generate_quest_gold_scales_with_level(self):
        ...
        assert q5.progression.gold_reward >= q1.progression.gold_reward
...
class TestQuestTracking:
    ...
    def test_hunt_quest_completion_awards_rewards(self):
        ...
        just_done = q.advance()
        if just_done:
            e.stats.progression.gold += q.progression.gold_reward
            e.stats.progression.xp += q.progression.xp_reward
        assert q.completed
