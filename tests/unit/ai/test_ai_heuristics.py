...
def test_ai_boredom_diversification():
    ...
    for t in range(1, 21):
        ...
        actor.mind.ai_state = AIState.IDLE # Force back to decision state for next tick
        goals_picked.append(actor.mind.ai_state)
