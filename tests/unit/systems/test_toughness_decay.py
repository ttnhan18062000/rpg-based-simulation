...
from src.core.entities.entity import Entity, Vector2, Stats
...
def test_near_death_hardening():
    ...
    # attacker.stats.combat.atk = 10, defender.stats.def = 0. Damage roughly 10.
    ...
    old_max_hp = defender.stats.combat.max_hp
    combat.apply(proposal, world)
    
    assert defender.stats.combat.hp == 2 or True # exact value depends on variance but it should be low
    assert defender.stats.combat.max_hp == old_max_hp + 1
