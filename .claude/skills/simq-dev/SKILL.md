---
name: simq-dev
description: Develop and debug src/simulation_quality/ scorers — add a new pillar, add a scoring rule, or debug why a pillar produced an unexpected score. Use for the development side of simulation quality, not the audit/governance workflow (that's the simq-audit skill).
source: project
