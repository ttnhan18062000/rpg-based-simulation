...
description: Work in src/cognition/, src/strategy/, src/ai/goals/ — the internal self-model, bounded strategic appraisal, goal hierarchy, and interruption resistance. Foregrounds the cognition/strategy/domain-decision boundary this repo draws, which a generic skill would get wrong. Use when editing or debugging any of these three subsystems.
source: project
