...
description: Work in src/domains/combat_engagement/ and combat resolution logic — the deterministic damage formula, tactical modifiers, CombatPosture pre-combat assessment, and the Sliding State pipeline ordering rule. Use when editing combat code or debugging combat outcome sequencing.
source: project
