...
description: Write backend API and read-model tests for this repo's real FastAPI service. Use when testing REST/WebSocket API endpoints, presenter shaping, or read-model cache behavior.
source: project
