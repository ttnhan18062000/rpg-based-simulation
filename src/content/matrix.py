...
CONTENT_USAGE_MATRIX: Dict[str, ContentFamilyMatrixEntry] = {
    ...
    "living/cognition_profiles": ContentFamilyMatrixEntry(
        ...
        resolver_component="LivingDefaultsResolver",
        compile_runtime_consumer="CompileContext, WorldCompiler, AdventureGoalScorer",
        test_coverage="tests/unit/content/test_catalog.py, tests/unit/content/test_layered_catalog.py",
        evidence_tests="tests/unit/content/test_resolvers.py::TestLivingDefaultsResolver",
        resolver_evidence="LivingDefaultsResolver fetches cognition profiles",
        runtime_consumer_evidence="AdventureGoalScorer.score() reads supports_adventure_routing for eligibility (TCK-20260810-COGNITION-PROFILE-ADVENTURE-ELIGIBILITY, relocated by TCK-20260811-DELETE-ADVENTURE-DECISION-PHASE)",
        implementation_state="RESOLVED_PARTIALLY",
        content_maturity="REDESIGNED-CORE",
    ),
    ...
    "social/species_relations": ContentFamilyMatrixEntry(
        file_path="social/species_relations.yaml",
        schema_class="SpeciesRelationRecord",
        repository_index="species_relations",
        validator_coverage="None",
        resolver_component="None",
        compile_runtime_consumer="RelationProjectionService",
        test_coverage="tests/unit/content/test_species_relations_catalog.py",
        evidence_tests="tests/unit/content_semantics/test_relation_species_projection.py::test_species_relations_hostility_changes_projected_label",
        resolver_evidence=None,
        runtime_consumer_evidence="RelationProjectionService resolves species_relations entries and factors axes.hostility into the projected label",
        implementation_state="RESOLVED_PARTIALLY",
    ...
    "social/personality_bias": ContentFamilyMatrixEntry(
        ...
        repository_index="None",
        validator_coverage="None",
        resolver_component="None (read directly by src.content_semantics.personality, not CatalogRepository)",
        compile_runtime_consumer="None (Design-Only)",
        test_coverage="tests/unit/content_semantics/test_personality.py",
        evidence_tests="tests/unit/content_semantics/test_personality.py::test_personality_bias_config_loads_from_real_data_file",
        resolver_evidence="None",
        runtime_consumer_evidence="WorldCompiler.compile() and ArchetypeEntityFactory.build_entity() both read bravery_bias_by_alignment_bucket and action_style_thresholds via src.content_semantics.personality (outside the CatalogRepository/resolver system) to bias per-entity personality/ActionStyle at generation",
        implementation_state="DESIGN_ONLY",
        content_maturity="REDESIGNED-CORE",
    ),
}
