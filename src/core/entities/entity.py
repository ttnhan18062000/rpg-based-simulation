...
class Entity(BaseModel):
    ...
    def copy(self) -> Entity:
        ...
        print(f"DEBUG_ENTITY_COPY: id={self.id} hp={self.combat.hp}/{self.combat.max_hp}")
        new_ent = Entity(
            id=self.id,
            kind=self.kind,
        ...
        print(f"DEBUG_ENTITY_COPY_RESULT: id={new_ent.id} hp={new_ent.combat.hp}/{new_ent.combat.max_hp}")
